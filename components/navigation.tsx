      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-black border border-neon-green rounded-lg flex items-center justify-center">
              <span className="text-neon-green font-mono text-sm font-bold">&gt;_</span>
            </div>
            <FuzzyText
              fontSize="1.25rem"
              color="#00ff41"
